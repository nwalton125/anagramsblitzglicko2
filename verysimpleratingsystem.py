...
def rate_game(player_dict, game_result):
	...
	while bags > 0:
		for player in game_result[0]:
			new_ratings[player] = (player_dict[player][0] + player_dict[player][1] * 100 * (game_result[0][player] / total_score - player_dict[player][0] / total_rating), max(1, player_dict[player][1] - 0.5))
